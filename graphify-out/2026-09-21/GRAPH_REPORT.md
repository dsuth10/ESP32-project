...
## Corpus Check
- 51 files · ~1,139,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 650 nodes · 1122 edges · 43 communities (20 shown, 15 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.85)
...
9. `_coeff_div` - 13 edges
10. `PowerManager` - 13 edges
...
Cohesion: 0.05
Nodes (71): SDFileEntry, DashboardStatus, EnvironmentMode, HealthState, String, TFT_eSPI, vector, VoiceUIState (+63 more)
...
Cohesion: 0.10
Nodes (24): esp_sleep_wakeup_cause_t, gpio_num_t, ChatLine, color, text, ChatMessage, isUser, text (+16 more)
...
## Knowledge Gaps
- **206 isolated node(s):** `1. Goal`, `2. Hardware facts that constrain the design`, `3.1 Product UI (this part works)`, `3.2 Attempt A — ESP32 deep sleep + EXT1 on GPIO17`, `3.3 Attempt B — Deep sleep, but put touch on EXT0` (+201 more)
...
- **Why does `MacroPadGUI` connect `MacroPadGUI` to `power_manager.cpp`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **What connects `1. Goal`, `2. Hardware facts that constrain the design`, `3.1 Product UI (this part works)` to the rest of the system?**
